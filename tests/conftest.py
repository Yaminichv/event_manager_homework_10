...
def login_request_data():
    return {"username": "john_doe_123","email":"john@email.com", "password": "SecurePassword123!"}

@pytest.fixture
def user_token():
    return create_access_token(data={"sub":"User","role":UserRole.AUTHENTICATED.value})
